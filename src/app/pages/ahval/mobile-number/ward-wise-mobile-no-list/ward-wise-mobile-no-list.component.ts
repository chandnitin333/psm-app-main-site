...
@Component({
  ...
  templateUrl: './ward-wise-mobile-no-list.component.html',
  styleUrl: './ward-wise-mobile-no-list.component.css'
})
export class WardWiseMobileNoListComponent {
  receivedData : any;
  adharList: any;
  ward_number: any;
...
get_adhar_ward_wise_list(){
  ...
  downloadPDF() {
        ...
        if (element) {
          ...
          const fileName = `मोबाईल_क्रमांक_यादी_${currentDate}.pdf`;
  ...
  downloadAndPreviewPDF() {
   ...
   downloadPDFMobile() {
    ...
    const fileName = `mobile_no_list_${currentDate}.pdf`;
