...
@Component({
  ...
  templateUrl: './audogyik.component.html',
  styleUrl: './audogyik.component.css'
})
export class audogyikComponent {
          ...
          .subscribe({
            next: (res: any) => {
              ...
              if(res?.data.length == 0){
                this.toastr.warning('No records found for औद्योगिक.', 'Warning');
