...
@Component({
  ...
  templateUrl: './ghar-kar.component.html',
  styleUrl: './ghar-kar.component.css'
})
export class GharKarComponent {
          ...
          .subscribe({
            next: (res: any) => {
              if(res?.data.length == 0){
                this.toastr.warning('No records found for Ghar Kar.', 'Warning');
