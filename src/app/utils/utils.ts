...
import { API_URL, ITEM_PER_PAGE } from '../../constant/admin.constant';
...
export class Util {
    ...
    openDialog(title: string, message: string, type: string): void { this.dialog.open(CommonDialogComponent, { data: { title, message, type } }); }
}
